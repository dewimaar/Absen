...
class EmployeeCreateForm extends Component
{
    ...
    public function mount()
    {
        ...
        $this->roles = Role::all();
        $this->employees = [
            ['name' => '', 'email' => '', 'phone' => '', 'password' => '', 'nip' => '', 'role_id' => User::USER_ROLE_ID, 'position_id' => $this->positions->first()->id]
        ];
    }

    public function addEmployeeInput(): void
    {
        $this->employees[] = ['name' => '', 'email' => '', 'phone' => '', 'password', 'nip' => '', 'role_id' => User::USER_ROLE_ID, 'position_id' => $this->positions->first()->id];
    }
    ...
    public function saveEmployees()
    {
        ...
        $this->validate([
            ...
            'employees.*.nip' => 'required|unique:users,nip', // Add this line for NIP validation
            'employees.*.password' => '',
