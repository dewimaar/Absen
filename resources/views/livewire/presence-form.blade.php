<div>
    ...
    {{-- jika tidak menggunakan qrcode (button) dan pegawai saat ini tidak menekan tombol izin --}}
    ...
    {{-- jika absen pulang sudah dimulai, dan pegawai sudah absen masuk dan belum absen pulang --}}
