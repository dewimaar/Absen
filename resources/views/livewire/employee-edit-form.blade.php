    ...
    <form wire:submit.prevent="saveEmployees" method="post" novalidate>
        ...
        <div class="mb-3">
            <div class="w-100">
                ...
                <div class="mb-3">
                    <x-form-label id="nip{{ $employee['id'] }}" label='NIP Pegawai {{ $loop->iteration }}' />
                ...
                <div class="mb-3">
                    <x-form-label id="password{{ $employee['id'] }}" label='Password hanya bisa diubah oleh pegawai'
                        required="false" />
                ...
                <div class="mb-3">
                    <x-form-label id="position_id{{ $employee['id'] }}"
                        label='Jabatan / Posisi Pegawai {{ $loop->iteration }}' />
