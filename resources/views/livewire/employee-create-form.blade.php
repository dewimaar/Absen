    ...
    <form wire:submit.prevent="saveEmployees" method="post" novalidate>
        ...
        <div class="mb-3">
            <div class="w-100">
                ...
                <div class="mb-3">
                    <x-form-label id="nip{{ $i }}" label='NIP Pegawai {{ $i + 1 }}' />
                ...
                <div class="mb-3">
                    <x-form-label id="password{{ $i }}"
                        label='Password Pegawai {{ $i + 1 }} (default: "123" jika tidak diisi)' required="false" />
                ...
                <div class="mb-3">
                    <x-form-label id="position_id{{ $i }}" label='Jabatan / Posisi Pegawai {{ $i + 1 }}' />
